...
<div class="space-y-6">
    ...
    <!-- Form -->
    <div class="card">
        <form action="{{ route('educator.courses.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            <!-- Basic Information -->
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="description" name="description" rows="4" required
                            class="form-input" placeholder="Enter course description">{{ old('description') }}</textarea>
                    </div>
                    <div>
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">Recommended size: 800x450px (16:9). Max 5MB.</p>
                </div>
            </div>

            <!-- Learning Outcomes, Prerequisites, and Completion Criteria -->
            <div x-data="{ 
                learning_outcomes: {{ old('learning_outcomes') ? json_encode(old('learning_outcomes')) : '[]' }},
                prerequisites: {{ old('prerequisites') ? json_encode(old('prerequisites')) : '[]' }},
                completion_criteria: {{ old('completion_criteria') ? json_encode(old('completion_criteria')) : '[]' }},
                newLearningOutcome: '',
                newPrerequisite: '',
